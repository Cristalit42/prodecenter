...
parcelRegister("ffpJH", function(module, exports) {
...
if (!overlay || !overlayOpen || !overlayClose) return;
...
overlay.addEventListener('click', (e)=>{
    if (e.target === overlay) overlay.classList.add('overlay--hidden');
});
...
parcelRequire("ffpJH");
const $f6ee944b143e57d5$var$headerLink = document.querySelector('.js-header__link');
const $f6ee944b143e57d5$var$headerSubMenu = document.querySelector('.js-header__submenu');
const $f6ee944b143e57d5$var$burgerMenu = document.querySelector('.js-burger');
const $f6ee944b143e57d5$var$burgerMenuBtn = document.querySelectorAll('.js-burger__btn');
if ($f6ee944b143e57d5$var$headerLink) $f6ee944b143e57d5$var$headerLink.addEventListener('click', (e)=>{
    e.preventDefault();
    $f6ee944b143e57d5$var$headerSubMenu.classList.toggle('header__nav-submenu--hidden');
    $f6ee944b143e57d5$var$headerLink.classList.toggle('header__link--active');
});
if ($f6ee944b143e57d5$var$burgerMenu) $f6ee944b143e57d5$var$burgerMenuBtn.forEach((btn)=>{
    btn.addEventListener('click', ()=>{
        $f6ee944b143e57d5$var$burgerMenu.classList.toggle('header__top-burger--hidden');
    });
});
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    if (!saleContent || !toggleButton) return;
    toggleButton.addEventListener('click', ()=>{
        const items = saleContent.querySelectorAll('.sale__content-item');
        isExpanded = !isExpanded;
        items.forEach((item, index)=>{
            if (index >= 8) {
                if (isExpanded) item.classList.add('visible');
                else item.classList.remove('visible');
            }
        });
        toggleButton.innerHTML = isExpanded ? "<span>\u0441\u043A\u0440\u044B\u0442\u044C</span>" : "<span>\u043F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0435\u0449\u0435</span>";
    });
});
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    const toggleButton = document.querySelector('.js-btn__show-more');
    let isExpanded = false;
    if (!blogContent || !toggleButton) return;
    toggleButton.addEventListener('click', ()=>{
...
let $03e35636502547b0$var$swiperInstance = null;
function $03e35636502547b0$var$initSwiper() {
    if (!$03e35636502547b0$var$swiperInstance) {
        $03e35636502547b0$var$swiperInstance = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)('.swiper', {
            modules: [
...
function $03e35636502547b0$var$destroySwiper() {
    if ($03e35636502547b0$var$swiperInstance) {
        $03e35636502547b0$var$swiperInstance.destroy(true, true);
        $03e35636502547b0$var$swiperInstance = null;
        console.log("Swiper \u0443\u043D\u0438\u0447\u0442\u043E\u0436\u0435\u043D");
    }
}
function $03e35636502547b0$var$handleResize() {
    if (window.innerWidth < 1300) $03e35636502547b0$var$initSwiper();
    else $03e35636502547b0$var$destroySwiper();
}
$03e35636502547b0$var$handleResize();
window.addEventListener('resize', $03e35636502547b0$var$handleResize);
